...
var AuditLogService = /** @class */ (function () {
    function AuditLogService(auditLogRepository) {
        this.auditLogRepository = auditLogRepository;
    }
    AuditLogService.prototype.writeLog = function (module, action, request, restricted) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.auditLogRepository.save(log)];
                    case 1:
                        result = _a.sent();
    ...
    AuditLogService = __decorate([
        common_1.Injectable(),
        __param(0, typeorm_1.InjectRepository(entity_1.AuditLog))
    ], AuditLogService);
